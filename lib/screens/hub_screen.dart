...
class _HubScreenState extends State<HubScreen> {
  ...
  Widget _buildBottomNavigationBar(bool isFa) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(
            color: GamingTheme.primary.withValues(alpha: 0.15),
            width: 1,
          ),
        ),
      ),
  ...
  // Floating Cyberpunk Jarvis Assistant Trigger Button
  Widget _buildJarvisFAB(BuildContext context, AppState appState) {
    return Container(
      ...
      child: FloatingActionButton(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(16),
          side: const BorderSide(color: GamingTheme.primary, width: 1.5),
        ),
        elevation: 10,
        child: Container(
          width: 56,
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: GamingTheme.primary.withValues(alpha: 0.3),
                blurRadius: 8,
                spreadRadius: 1,
              )
            ],
          ...
          child: const Center(
            child: Icon(
              Icons.rocket_launch, // Cyberpunk rocket / robot icon representation
              color: GamingTheme.primary,
              size: 24,
            ),
          ),
